...
const IDENTITY_FAILURE_MESSAGES: Record<string, string> = {
  ...
  selfie_face_missing: "No face was detected. The party must retake the face check on mobile.",
  face_match_failed: "The face check did not match the Ghana Card portrait. The party must retry on mobile.",
